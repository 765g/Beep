...
local GameProfiles = {
    ["Universal"] = {part = "Head", visible = false, prediction = 0,  fireRate = 0.05, fireMethod = "auto"},
    ["Rivals"]    = {part = "Head", visible = true,  prediction = 0,  fireRate = 0.05, fireMethod = "click"},
    ["Arsenal"]   = {part = "Head", visible = false, prediction = 0,  fireRate = 0.03, fireMethod = "click"},
